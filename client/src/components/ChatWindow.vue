    ...
    <div>
        <div class="max-w-lg  mx-2 bg-white p-8 rounded-xl shadow shadow-slate-300 ">
            ...
            <form class="  flex justify-center align-center mt-12">
                ...
                <input v-model="message" class="items-center h-10 w-full rounded border px-3 text-sm" type="text"
                    placeholder="Type your message…" required>

                <button type="submit"
                    class="text-sm flex  ml-4 align-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
